...
This privacy policy applies to all services provided in all versions of Abstract Games. The developer may separately set a privacy policy or terms of use (individual contracts) for each service, and in the case of specifying the handling of information separately in the individual contracts, the provision of the individual contracts will prevail.
Please note that this privacy policy does not apply to the handling of information at the link destination when moving from a link displayed on Abstract Games to an external website or the like.
...
The developer does not collect and use any other personal information through Abstract Games. Please use Abstract Games with confidence.

### 3. Changes to this privacy policy
This privacy policy may change from time to time. If the developer decides to change this privacy policy, he will provide you additional forms of notice of modifications or updates as appropriate under the circumstances. Your continued use of Abstract Games following the posting of changes will mean you accept those changes.
